    ...
    <div>
      <div style={{ background: 'var(--ink)', color: 'var(--cream)', padding: '64px 0 48px' }}>
        <div className="container" style={{ maxWidth: 700 }}>
          <div
            className="tag"
            style={{ background: 'rgba(200,119,58,0.25)', color: '#e8a070', marginBottom: 16 }}
          >
            Expert guides
          </div>
          ...
          <p style={{ color: 'rgba(250,248,244,0.65)', fontSize: 16, lineHeight: 1.7 }}>
            Expert guides on poodle haircuts, grooming schedules, health, and behavior — everything
            the US and Canadian poodle owner community is searching for.
          </p>
        </div>
      </div>
            ...
            {rest.map(post => {
              ...
              return (
                ...
                >
                  ...
                  <span style={{ color: 'var(--caramel)', fontSize: 18, flexShrink: 0, marginTop: 4 }}>
                    →
                  </span>
                </a>
              )
